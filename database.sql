...
(2, 'body', 'BODY ACCESSORIES', 'Front & Mudguard', 3000, 'https://picsum.photos/200', 'FRONT FAIRING AND MUDGUARD KARIZMA R ZADON\r\n\r\nThis COMBO BODY PARTS is suitable for : HERO HONDA KARIZMA,HERO HONDA KARIZMA R,HERO HONDA KARIZMA R NM', '{\"BoxPackWeight\": {\"approx\": \"1000.00 Grams\"},\"BoxPackVolume\": {\"approx\": \"4000 CC\",\"volumetricWeightApplied\": \"0.80 Kg\"},\"ShippingCharge\": {\"amount\": \"Rs.400.00\",\"minFor\": \"Minimum for\"}}', NULL, 1),
(3, 'battery', 'BATTERY', 'Amaron', 3000, 'https://picsum.photos/200', 'AMARON HI LIFE FLO 36B20L 36 ah BATTERY FOR PETROL bike\r\n\r\nMaintenance free<br>\r\nFactory charged and ready to fit<br>\r\nHigh cranking power<br>\r\n55 months warranty<br>\r\nCompatible With Vehicle Type: Passenger bike', '{\"Brand\": \"Amaron\",\"VehicleServiceType\": \"Bike\",\"Voltage\": \"12 Volts\"}', NULL, 1),
...
(7, 'gear', 'GEAR & CLUTCH', 'Clutch set', 8250, 'https://picsum.photos/200', 'Clutch Set (Clutch + Pressure Plate) Hyundai Santro/ i10 O/M/ I10 Magna (Valeo)', '{\"Manufacturer\": \"Valeo\",\"Brand\": \"Valeo\",\"PackageDimensions\": \"26.01 x 24 x 5.99 cm; 3.04kg\",\"ItemModelNumber\": \"404514\",\"Weight\": \"3 kg 40g\"}', NULL, 1),
(8, 'abs', 'ABS', 'pesky break', 250, 'https://picsum.photos/200', 'This Product is Bicycle Black Clutch Lever for Bicycles use in Brake and best part of this product we are provide best Quality combo pack for You in this Combo Pack High Quality Break Lever Clutch With Break Shoe this product for Ranger Cycles', '{\"Brand\": \"PESKY\",\"Model Number\": \"Bicycle Clutch Lever + Break Shoe Combo\",\"Shade\": \"Black\"}', NULL, NULL),
(9, 'abs', 'ABS', 'disk lock', 390, 'https://picsum.photos/200', 'thetrishafab Disk Lock Heavy Stainless Steel Disc Break Security _0043 Motorbike Brake Disc\r\n\r\nDisk Lock Made from a solid cast of stainless steel, Trest Anti Theft Disc Brake Lock features a hardened locking pin that makes this device almost impossible to drill, saw, cut or hammer off. This stylish compact theft deterrent is simple and can be stored almost anywhere, even your pocket until it is needed for duty', '{\"Brand\": \"thetrishafab\",\"Model Number\": \"Disk Lock Heavy Stainless Steel Disc Break Security _0043\"}', NULL, NULL),
(10, 'abs', 'ABS', 'Break rotator', 1700, 'https://picsum.photos/200', 'In order to meet requirements of our clients, we are offering to our clients technically advanced range of Disc Brake Rotors in order to match their expectations and requirements. These Disc Brake Rotors are able to prevent rust and corrosion with clear looking coating protection and provide clean look for open-wheeled vehicles.', NULL, NULL, 1),
